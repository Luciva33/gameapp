...
class SceneTitle {
	...
	static anim(gameData, time) {
		...
		// 文字の描画
		UiText.drawCenter(context, textArr[0], w2, h * 0.2 | 0, 28, 'white');
		if (isView) {
			UiText.drawCenter(context, textArr[1], w2, h * 0.6 | 0, 10, 'white');
		}
		UiText.drawCenter(context, textArr[2], w2, h * 0.86 | 0, 10, 'white');
		UiText.drawCenter(context, textArr[3], w2, h * 0.94 | 0, 10, 'white');
